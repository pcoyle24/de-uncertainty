function [o1,o2,o3,o4] = allterp441( x1, x2, x3, x4, ...
                                  x1i, x2i, x3i, x4i, ...
                                  pf1, pf2, pf3, pf4)

% allterp441 linear inter/extrapolation (4 states, 4 policies, 1 stoch comp)
% Inputs:
        ...
        for m3 = 0:1
            for m2 = 0:1
                for m1 = 0:1
                    ...
                    o3(i4) = o3(i4) + w1(m1+1)*w2(m2+1)*w3(m3+1)*w4(m4+1)*pf3(loc1+m1,loc2+m2,loc3+m3,loc4+m4);
                    o4(i4) = o4(i4) + w1(m1+1)*w2(m2+1)*w3(m3+1)*w4(m4+1)*pf4(loc1+m1,loc2+m2,loc3+m3,loc4+m4);
                end
            end
        end
    end
