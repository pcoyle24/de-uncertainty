function [o1,o2] = allterp321( x1, x2, x3, ...
                               x1i, x2i, x3i, ...
                               pf1, pf2)

% allterp321 linear inter/extrapolation (3 states, 2 policies, 1 stoch comp)
% Inputs:
%   x*      :   Grid
...
for i3 = 1:x3ipts
    ...
    for m3 = 0:1
        for m2 = 0:1
            for m1 = 0:1
                o1(i3) = o1(i3) + w1(m1+1)*w2(m2+1)*w3(m3+1)*pf1(loc1+m1,loc2+m2,loc3+m3);
                o2(i3) = o2(i3) + w1(m1+1)*w2(m2+1)*w3(m3+1)*pf2(loc1+m1,loc2+m2,loc3+m3);                
            end
        end
    end
end