...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
    ...
    ! Array information
	mwSize nx1,nx2,nx3,nx4,nx5,nodes,e5
	integer*4 myclassid
	double precision, allocatable, dimension(:) :: x1,x2,x3,x4,x5,x5i
    ...
    allocate(o2(e5))
    allocate(o3(e5))
    plhs(1) = mxCreateNumericArray(1,e5,myclassid,0)
    plhs(2) = mxCreateNumericArray(1,e5,myclassid,0)
    plhs(3) = mxCreateNumericArray(1,e5,myclassid,0) 
    o1_pr = mxGetPr(plhs(1))
    o2_pr = mxGetPr(plhs(2))
    o3_pr = mxGetPr(plhs(3))
    
    ! Call subroutine for assignment
    call allterp(o1,o2,o3,nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i,pf1,pf2,pf3,e5)
        
    ! Load Fortran array to pointer (output to MATLAB)
    call mxCopyReal8ToPtr(o1,o1_pr,e5)
    call mxCopyReal8ToPtr(o2,o2_pr,e5)
    call mxCopyReal8ToPtr(o3,o3_pr,e5)  
...
subroutine allterp(o1,o2,o3,nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i,pf1,pf2,pf3,e5)

    implicit none
    mwSize :: nx1,nx2,nx3,nx4,nx5,e5
    mwSize i5
    ...
    double precision, dimension(e5) :: o1,o2,o3

    ! Interpolate
    do i5 = 1,e5
        o1(i5) = fastrap(nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i(i5),pf1)
        o2(i5) = fastrap(nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i(i5),pf2)
        o3(i5) = fastrap(nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i(i5),pf3)
    end do
