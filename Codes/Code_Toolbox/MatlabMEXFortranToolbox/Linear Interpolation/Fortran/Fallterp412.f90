...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
    ...
    call allterp(o1,nx1,nx2,nx3,nx4,x1,x2,x3,x4,x1i,x2i,x3i,x4i,pf1,e3,e4)
...
subroutine allterp(o1,nx1,nx2,nx3,nx4,x1,x2,x3,x4,x1i,x2i,x3i,x4i,pf1,e3,e4)
    ...
    double precision, dimension(nx1,nx2,nx3,nx4) :: pf1
    double precision, dimension(e3) :: x3i
    double precision, dimension(e4) :: x4i
    double precision, dimension(e3,e4) :: o1
