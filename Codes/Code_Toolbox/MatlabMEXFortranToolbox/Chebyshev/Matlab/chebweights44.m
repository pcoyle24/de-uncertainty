function [A1 A2 A3 A4] = chebweights44( n1,n2,n3,n4, ...
                                        f1,f2,f3,f4,...
                                        T,P,X)

% [A1 A2 A3 A4] = chebweights44( n1,n2,n3,n4, ...
%                                f1,f2,f3,f4,...
%                                T,P,X)
% Computes the Chebychev polynomial parameters for 4 functions with 4
%   dimensions.
% Inputs:
