...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)    
    ...
    call chebweights(A1,A2,n(1),n(2),n(3),m(1),m(2),m(3),mmax,f1,f2,T,P,X)
...
subroutine chebweights(A1,A2,nn1,nn2,nn3,m1,m2,m3,mmax,f1,f2,T,P,X)

    implicit none
    mwSize :: nn1,nn2,nn3,mmax,m1,m2,m3
    double precision, dimension(nn1,nn2,nn3) :: A1,A2
    double precision, dimension(m1,m2,m3) :: f1,f2
