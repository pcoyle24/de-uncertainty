...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)    
    ...
    plhs(1) = mxCreateDoubleMatrix(ne4,ne5,0)   
    plhs(2) = mxCreateDoubleMatrix(ne4,ne5,0)   
    plhs(3) = mxCreateDoubleMatrix(ne4,ne5,0)   
    o1 => mxGetPr(plhs(1))   
    o2 => mxGetPr(plhs(2))   
    o3 => mxGetPr(plhs(3))
    
    ! Call subroutine for assignment
    call allterp(o1,o2,o3,nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i,r1,r2,r3,ne4,ne5)

end subroutine mexFunction

subroutine allterp(o1,o2,o3,nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i,r1,r2,r3,ne4,ne5)
    ...
    double precision, dimension(ne4,ne5) :: o1,o2,o3

    ! Interpolate
    do i4 = 1,ne4  
      do i5 = 1,ne5  
        o1(i4,i5) = fastrap(nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i(i4),x5i(i5),r1)
        o2(i4,i5) = fastrap(nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i(i4),x5i(i5),r2)
        o3(i4,i5) = fastrap(nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i(i4),x5i(i5),r3)
      end do
    end do
