...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)    
    ...
    call allterp(o1,o2,nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i,r1,r2,ne4,ne5)

end subroutine mexFunction

subroutine allterp(o1,o2,nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i,r1,r2,ne4,ne5)
    ...
    double precision, dimension(nx1,nx2,nx3,nx4,nx5) :: r1,r2
    double precision, dimension(ne4) :: x4i
    double precision, dimension(ne5) :: x5i
    double precision, dimension(ne4,ne5) :: o1,o2
