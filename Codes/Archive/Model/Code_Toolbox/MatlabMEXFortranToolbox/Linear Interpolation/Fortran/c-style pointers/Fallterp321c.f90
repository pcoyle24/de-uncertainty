...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)    
    ...
    plhs(2) = mxCreateDoubleMatrix(ne3,1,0)    
    o1 => mxGetPr(plhs(1))
    o2 => mxGetPr(plhs(2))
    
    ! Call subroutine for assignment
    call allterp(o1,o2,nx1,nx2,nx3,x1,x2,x3,x1i,x2i,x3i,pf1,pf2,ne3)

end subroutine mexFunction

subroutine allterp(o1,o2,nx1,nx2,nx3,x1,x2,x3,x1i,x2i,x3i,pf1,pf2,ne3)
    ...
    double precision, dimension(ne3) :: o1,o2
