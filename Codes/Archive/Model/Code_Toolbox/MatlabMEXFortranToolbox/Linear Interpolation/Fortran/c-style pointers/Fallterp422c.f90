...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)    
    ...
    plhs(2) = mxCreateDoubleMatrix(ne3,ne4,0)   
    o1 => mxGetPr(plhs(1))   
    o2 => mxGetPr(plhs(2))
    
    ! Call subroutine for assignment
    call allterp(o1,o2,nx1,nx2,nx3,nx4,x1,x2,x3,x4,x1i,x2i,x3i,x4i,r1,r2,ne3,ne4)

end subroutine mexFunction

subroutine allterp(o1,o2,nx1,nx2,nx3,nx4,x1,x2,x3,x4,x1i,x2i,x3i,x4i,r1,r2,ne3,ne4)
    ...
    double precision, dimension(nx1,nx2,nx3,nx4) :: r1,r2
    double precision, dimension(ne3) :: x3i
    double precision, dimension(ne4) :: x4i
    double precision, dimension(ne3,ne4) :: o1,o2

    ! Interpolate
    do i4 = 1,ne4
      do i3 = 1,ne3    
        o1(i3,i4) = fastrap(nx1,nx2,nx3,nx4,x1,x2,x3,x4,x1i,x2i,x3i(i3),x4i(i4),r1)
        o2(i3,i4) = fastrap(nx1,nx2,nx3,nx4,x1,x2,x3,x4,x1i,x2i,x3i(i3),x4i(i4),r2)
      end do
    end do
