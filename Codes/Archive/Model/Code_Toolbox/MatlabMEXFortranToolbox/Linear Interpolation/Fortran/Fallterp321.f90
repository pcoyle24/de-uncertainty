...
subroutine allterp(o1,o2,nx1,nx2,nx3,x1,x2,x3,x1i,x2i,x3i,pf1,pf2,e3)
    ...
    double precision, dimension(nx1,nx2,nx3) :: pf1,pf2
    double precision, dimension(e3) :: x3i
    double precision, dimension(e3) :: o1,o2

    ! Interpolate
    do i3 = 1,e3
        o1(i3) = fastrap(nx1,nx2,nx3,x1,x2,x3,x1i,x2i,x3i(i3),pf1)
        o2(i3) = fastrap(nx1,nx2,nx3,x1,x2,x3,x1i,x2i,x3i(i3),pf2)       
    end do
