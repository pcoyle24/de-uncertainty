...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)   
    ...
    call allterp(o1,o2,nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i,pf1,pf2,e4,e5)
...
subroutine allterp(o1,o2,nx1,nx2,nx3,nx4,nx5,x1,x2,x3,x4,x5,x1i,x2i,x3i,x4i,x5i,pf1,pf2,e4,e5)
    ...
    double precision, dimension(e4,e5) :: o1,o2
