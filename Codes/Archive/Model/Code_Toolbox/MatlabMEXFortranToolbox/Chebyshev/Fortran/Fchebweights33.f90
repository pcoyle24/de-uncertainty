...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)    
    ...
    ! Array information
	mwSize :: m(3),n1,n2,n3,nn1,nn2,nn3,n(3)
    ...
    allocate(f3(m(1),m(2),m(3)))     
    f1_pr = mxGetPr(prhs(4))
    f2_pr = mxGetPr(prhs(5))
    f3_pr = mxGetPr(prhs(6))   
    ...
    call chebweights(A1,A2,A3,n(1),n(2),n(3),m(1),m(2),m(3),mmax,f1,f2,f3,T,P,X)
...
subroutine chebweights(A1,A2,A3,nn1,nn2,nn3,m1,m2,m3,mmax,f1,f2,f3,T,P,X)

    implicit none
    mwSize :: nn1,nn2,nn3,mmax,m1,m2,m3
    double precision, dimension(nn1,nn2,nn3) :: A1,A2,A3
    double precision, dimension(m1,m2,m3) :: f1,f2,f3
    ...
    double precision tt1,tt2,tt3,nestsum1,nestsum2,nestsum3,temp
          ...
          do i3 = 1,m3
           do i2 = 1,m2
            do i1 = 1,m1               
             ...
             nestsum2 = nestsum2 + f2(i1,i2,i3)*tt1*tt2*tt3;
             nestsum3 = nestsum3 + f3(i1,i2,i3)*tt1*tt2*tt3;               
            end do
           end do
          end do           
