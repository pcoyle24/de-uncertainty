...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
	...
	double precision, allocatable, dimension(:) :: z4i,f1,f2,f3
    ...
    call allcheb(f1,f2,f3,e4,z1i,z2i,z3i,z4i,z1_bnd,z2_bnd,z3_bnd,z4_bnd,m(1),m(2),n(1),n(2),n(3),n(4),T,P,A1,A2,A3)
...
subroutine allcheb(f1,f2,f3,e4,z1i,z2i,z3i,z4i,z1_bnd,z2_bnd,z3_bnd,z4_bnd,m1,m2,nn1,nn2,nn3,nn4,T,P,A1,A2,A3)

    implicit none
    mwSize :: e4,m1,m2,nn1,nn2,nn3,nn4
    double precision :: z1i,z2i,z3i,x1i,x2i,x3i,x4i
    double precision, dimension(e4) :: z4i,f1,f2,f3
    double precision, dimension(2) :: z1_bnd,z2_bnd,z3_bnd,z4_bnd  
