...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)    
    ...
    c_pr = mxGetDimensions(prhs(12))
    call mxCopyPtrToInteger4(c_pr,c,2)
    chebs = c(1)*c(2)
    allocate(T(c(1),c(2)))
    allocate(P(c(1),c(2)))
    T_pr = mxGetPr(prhs(12))
    P_pr = mxGetPr(prhs(13))
    ...
    call allcheb(f1,f2,f3,nodes,z1i,z2i,z3i,z4i,z1_bnd,z2_bnd,z3_bnd,z4_bnd,c(1),c(2),n(1),n(2),n(3),n(4),m(1),m(2),m(3),m(4),m(5),T,P,A1,A2,A3)
...
subroutine allcheb(f1,f2,f3,nodes,z1i,z2i,z3i,z4i,z1_bnd,z2_bnd,z3_bnd,z4_bnd,c1,c2,nn1,nn2,nn3,nn4,m1,m2,m3,m4,m5,T,P,A1,A2,A3)

    implicit none
    mwSize :: nodes,c1,c2,nn1,nn2,nn3,nn4,m1,m2,m3,m4,m5
    double precision, dimension(m1,m2,m3,m4,m5) :: z1i,z2i,z3i,z4i,f1,f2,f3
    double precision, dimension(2) :: z1_bnd,z2_bnd,z3_bnd,z4_bnd
