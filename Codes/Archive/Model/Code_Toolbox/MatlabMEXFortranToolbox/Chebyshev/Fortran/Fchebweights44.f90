...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)    
    ...
    plhs(4) = mxCreateNumericArray(ndim,n,myclassid,0)
    A1_pr = mxGetPr(plhs(1))
    A2_pr = mxGetPr(plhs(2))
    A3_pr = mxGetPr(plhs(3))
    A4_pr = mxGetPr(plhs(4))
    
    ! Call subroutine for assignment
    call chebweights(A1,A2,A3,A4,n(1),n(2),n(3),n(4),m(1),m(2),m(3),m(4),mmax,f1,f2,f3,f4,T,P,X)
    ...
    call mxCopyReal8ToPtr(A4,A4_pr,coefs)
...
subroutine chebweights(A1,A2,A3,A4,nn1,nn2,nn3,nn4,m1,m2,m3,m4,mmax,f1,f2,f3,f4,T,P,X)

    implicit none
    mwSize :: nn1,nn2,nn3,nn4,mmax,m1,m2,m3,m4
    double precision, dimension(nn1,nn2,nn3,nn4) :: A1,A2,A3,A4
    double precision, dimension(m1,m2,m3,m4) :: f1,f2,f3,f4
    ...
    double precision tt1,tt2,tt3,tt4,nestsum1,nestsum2,nestsum3,nestsum4,temp
             ...
             do i3 = 1,m3
              do i2 = 1,m2
               do i1 = 1,m1
                ...
                nestsum4 = nestsum4 + f4(i1,i2,i3,i4)*tt1*tt2*tt3*tt4;
               end do
              end do
             end do 
            end do
