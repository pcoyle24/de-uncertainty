%--------------------------------------------------------------------------
% File Name: moments_iid.m
% Author: Philip Coyle
% Date Created: 01/24/2019
% cd /mq/philipprojects/RA_Work/Taisuke_Nakata/Zero_Lower_Bound/DeflationaryRegime/Uncertainty/Codes/RiskAdjFisherRelation/3state_iid_shock/Moments
% moments_iid
%--------------------------------------------------------------------------
...
cSIGMAd_grid = linspace(0,cSIGMAd_max,51);
...
ylims = [0 0.3; -1 0; 0 1;-0.01 0.1; -1 0.1; 0 1.2;0 100];
...
print(fig(1),'-depsc','iid_moments.eps');
