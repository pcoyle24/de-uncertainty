...
cRHO    = 0.8;
cPItarg= 2/400; 
cSIGMAd_grid = [ 0.55/100,  0.60/100,  cSIGMAd_max.m];
...
% print(fig(1),'-dpdfc','stylized_rouwenhorst_RAFR_cPHIpi_l.pdf');
print(fig(1),'-dpdf',strcat(savedir,'stylized_rouwenhorst_RAFR_cPHIpi_l_cPItarg.pdf'));
