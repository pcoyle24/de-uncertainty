...
cRstar = 1/400;
cRHO    = 0.8;
cSIGMAd_grid = [ 0.15/100,  0.19/100,  cSIGMAd_max.m];
...
% print(fig(1),'-depsc','stylized_rouwenhorst_RAFR_cPHIpi_m.eps');
print(fig(1),'-depsc',strcat(savedir,'stylized_rouwenhorst_RAFR_cPHIpi_m.eps'));
