...
% set(gca,'Xlim',[400*pi_m(1), 400*pi_m(end)],'Ylim',[-0.5, 1.5],'FontSize',25)
L = legend([h(1) h(2) h(3)],'c = 0.03','c = 0.075','c = c_{max}');
...
% print(fig(1),'-depsc','RAFR_cPHIpi_l.eps');
print(fig(1),'-depsc',strcat(savedir,'RAFR_cPHIpi_l.eps'));
