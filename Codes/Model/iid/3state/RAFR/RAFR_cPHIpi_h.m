...
cSHOCK_grid = [0.075, 0.09, max([cSHOCK_lb,cSHOCK_ub,cSHOCK_bound])];
...
L = legend([h(1) h(2) h(3)],'c = 0.075','c = 0.09','c = c_{max}');
...
% print(fig(1),'-depsc','RAFR_cPHIpi_h.eps');
print(fig(1),'-depsc',strcat(savedir,'RAFR_cPHIpi_h.eps'));
