%--------------------------------------------------------------------------
% File Name: stylized_rouwenhorst_RAFR_cPHIpi_l.m
% Author: Philip Coyle
...
% stylized_rouwenhorst_RAFR_cPHIpi_l
%--------------------------------------------------------------------------
...
cRstar = 1/400;
cRHO    = 0.8;
cSIGMAd_grid = [ 0.15/100,  0.19/100,  cSIGMAd_max.l];
...
L = legend([h(1) h(2) h(3)],'\sigma_{\epsilon} = 0.15/100','\sigma_{\epsilon} = 0.19/100','\sigma_{\epsilon} = \sigma_{\epsilon}^{max}');
...
% print(fig(1),'-depsc','stylized_rouwenhorst_RAFR_cPHIpi_l.eps');
print(fig(1),'-depsc',strcat(savedir,'stylized_rouwenhorst_RAFR_cPHIpi_l.eps'));
