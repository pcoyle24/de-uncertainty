...
ylims = [0 0.3; -1 0; 0 1;-0.005 0.005; -1.001 0.001; 0 1.2;0 100];
...
% print(fig(1),'-depsc','stylized_rouwenhorst_moments_cPHIpi_l.eps');
print(fig(1),'-depsc',strcat(savedir,'stylized_rouwenhorst_moments_cPHIpi_l.eps'));
