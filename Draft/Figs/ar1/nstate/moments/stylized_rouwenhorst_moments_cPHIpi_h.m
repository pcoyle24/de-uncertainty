%--------------------------------------------------------------------------
% File Name: stylized_rouwenhorst_moments_cPHIpi_h.m
% Author: Philip Coyle
...
% matlab -nodesktop -nosplash -r stylized_rouwenhorst_moments_cPHIpi_h
%--------------------------------------------------------------------------
...
ylims = [0 0.5; -1 0; 0 1.01;-0.01 0.005; -1.01 0.1; 0 1.4;0 100];
...
% print(fig(1),'-depsc','stylized_rouwenhorst_moments_cPHIpi_h.eps');
print(fig(1),'-depsc',strcat(savedir,'stylized_rouwenhorst_moments_cPHIpi_h.eps'));
