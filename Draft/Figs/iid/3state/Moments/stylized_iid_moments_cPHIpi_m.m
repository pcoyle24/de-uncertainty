%--------------------------------------------------------------------------
% File Name: stylized_iid_moments_cPHIpi_m.m
% Author: Philip Coyle
...
% print(fig(1),'-depsc','stylized_iid_moments_cPHIpi_m.eps');
print(fig(1),'-depsc',strcat(savedir,'stylized_iid_moments_cPHIpi_m.eps'));
