%--------------------------------------------------------------------------
% File Name: moments_stylized_rouwenhorst.m
% Author: Philip Coyle
% Date Created: 01/18/2019
% cd /mq/philipprojects/RA_Work/Taisuke_Nakata/Zero_Lower_Bound/DeflationaryRegime/Uncertainty/Draft/Figs/Fig11
% moments_stylized_rouwenhorst
%--------------------------------------------------------------------------
...
cRstar = 1/400;
cRHO = 0.8; 
cSIGMAd_grid = linspace(0,0.355/100,51);
...
ylims = [0 0.3; -1 0; 0 1;-0.3 0.01; -1 0.1; 0 1.2;0 100];
...
print(fig(1),'-depsc','rouwenhorst_moments_cPHIpi2.eps');
