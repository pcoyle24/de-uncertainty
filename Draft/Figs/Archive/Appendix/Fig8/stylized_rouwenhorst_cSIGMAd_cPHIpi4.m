%--------------------------------------------------------------------------
% File Name: stylized_rouwenhorst_cSIGMAd_cPHIpi4.m
% Author: Philip Coyle
...
% stylized_rouwenhorst_cSIGMAd_cPHIpi4
%--------------------------------------------------------------------------
...
cRstar = 1/400;
cRHO    = 0.8;
cSIGMAd_grid = [ 0.15/100,  0.30/100,  0.36625/100];
...
L = legend([h(1) h(2) h(3)],'\sigma_{\epsilon} = 0.15/100','\sigma_{\epsilon} = 0.30/100','\sigma_{\epsilon} = \sigma_{\epsilon}^{max}');
set(L,'Location','NorthWest','Fontsize',20)

set(fig(1),'PaperOrientation','Landscape');
set(fig(1),'PaperPosition',[0 0 11 8.5]);
print(fig(1),'-depsc','AR1_RAFR_cPHIpi4.eps');
