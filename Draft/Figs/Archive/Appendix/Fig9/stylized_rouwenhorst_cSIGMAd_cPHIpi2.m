%--------------------------------------------------------------------------
% File Name: stylized_rouwenhorst_cSIGMAd_cPHIpi2.m
% Author: Philip Coyle
...
% stylized_rouwenhorst_cSIGMAd_cPHIpi2
%--------------------------------------------------------------------------
...
cRstar = 1/400;
cRHO    = 0.8;
cSIGMAd_grid = [ 0.15/100,  0.30/100,  0.35625/100];
...
print(fig(1),'-depsc','AR1_RAFR_cPHIpi2.eps');
