%--------------------------------------------------------------------------
% File Name: stylized_iid_cPHIpi_5.m
% Author: Philip Coyle
...
L = legend([h(1) h(2) h(3)],'c = 0.13','c = 0.25','c = c_{max}');
set(L,'Location','NorthWest','Fontsize',20)

set(fig(1),'PaperOrientation','Landscape');
set(fig(1),'PaperPosition',[0 0 11 8.5]);
print(fig(1),'-depsc','IID_RAFR_cPHIpi_5.eps');
