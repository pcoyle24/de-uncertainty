%--------------------------------------------------------------------------
% File Name: stylized_iid_cPHIpi_1dot1.m
% Author: Philip Coyle
...
cPHIpi = 1.1;
cRstar = 1/400;
cSIGMAd_grid = [0.13, 0.20 0.29212;];
...
L = legend([h(1) h(2) h(3)],'c = 0.13','c = 0.20','c = c_{max}');
set(L,'Location','NorthWest','Fontsize',20)

set(fig(1),'PaperOrientation','Landscape');
set(fig(1),'PaperPosition',[0 0 11 8.5]);
print(fig(1),'-depsc','IID_RAFR_cPHIpi_1dot1.eps');
