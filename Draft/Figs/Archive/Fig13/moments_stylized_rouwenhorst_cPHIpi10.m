%--------------------------------------------------------------------------
% File Name: moments_stylized_rouwenhorst_cPHIpi10.m
% Author: Philip Coyle
% Date Created: 01/18/2019
% cd /mq/philipprojects/RA_Work/Taisuke_Nakata/Zero_Lower_Bound/DeflationaryRegime/Uncertainty/Draft/Figs/Fig13
% moments_stylized_rouwenhorst_cPHIpi10
%--------------------------------------------------------------------------
...
cRstar = 1/400;
cRHO = 0.8; 
cSIGMAd_grid = linspace(0,0.364/100,51);
...
ylims = [0 0.5; -1 0; 0 1.01;-0.5 0.01; -1.01 0.1; 0 1.4;0 100];
...
print(fig(1),'-depsc','rouwenhorst_moments_cPHIpi10.eps');
