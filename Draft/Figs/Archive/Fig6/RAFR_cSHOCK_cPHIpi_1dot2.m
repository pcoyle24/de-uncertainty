%--------------------------------------------------------------------------
% File Name: RAFR_cSHOCK_cPHIpi_1dot2.m
% Author: Philip Coyle
...
cSHOCK_grid = [0.1, 0.20 max([cSHOCK_lb,cSHOCK_ub,cSHOCK_bound])];
...
set(gca,'Xlim',[400*pi_m(1), 400*pi_m(end)],'Ylim',[-1.5, 4],'FontSize',25)
L = legend([h(1) h(2) h(3)],'c = 0.10','c = 0.20','c = c_{max}');
set(L,'Location','NorthWest','Fontsize',25)

set(fig(1),'PaperOrientation','Landscape');
set(fig(1),'PaperPosition',[0 0 11 8.5]);
print(fig(1),'-depsc','RAFR_cPHIpi_1dot2.eps');
